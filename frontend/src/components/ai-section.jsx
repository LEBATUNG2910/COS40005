...
function AISection() {
  const features = [
    { title: "AI content generation", description: "Leverage AI to create compelling resume content" },
    { title: "AI resume grading", description: "Get instant feedback on your resume quality" },
    { title: "AI skills builder", description: "Improve your skills with AI-powered suggestions" },
  ]
  ...
  return (
    <section className="relative py-20 bg-gradient-to-r from-gray-900 via-purple-900 to-gray-900 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Fully equipped for the age of AI</h2>
          <p className="text-xl text-gray-300">Your AI-powered resume builder for the modern job seeker</p>
        </motion.div>
