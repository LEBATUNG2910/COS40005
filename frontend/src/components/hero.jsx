    ...
    const floatingCards = [
        {
            ...
            avatars: [
                ...
                {
                    src: "https://placehold.co/32x32/4ECDC4/FFFFFF?text=B",
                    alt: "User 2",
                },
                {
                    src: "https://placehold.co/32x32/45B7D1/FFFFFF?text=C",
                    alt: "User 3",
                },
                {
                    src: "https://placehold.co/32x32/FFA07A/FFFFFF?text=D",
                    alt: "User 4",
                },
            ],
        ...
        },
        {
            ...
            description:
                "Match your skills with the perfect job opportunities using AI.",
            avatars: [
                {
                    src: "https://placehold.co/32x32/9B59B6/FFFFFF?text=E",
                    alt: "User 5",
                },
                {
                    src: "https://placehold.co/32x32/3498DB/FFFFFF?text=F",
                    alt: "User 6",
                },
            ],
        ...
        },
        {
            ...
            avatars: [
                {
                    src: "https://placehold.co/32x32/E74C3C/FFFFFF?text=G",
                    alt: "User 7",
                },
                {
                    src: "https://placehold.co/32x32/F39C12/FFFFFF?text=H",
                    alt: "User 8",
                },
                {
                    src: "https://placehold.co/32x32/27AE60/FFFFFF?text=I",
                    alt: "User 9",
                },
            ],
        ...
        },
        {
            ...
            description:
                "Generate personalized cover letters tailored to the job you're applying for.",
            avatars: [
                {
                    src: "https://placehold.co/32x32/1ABC9C/FFFFFF?text=J",
                    alt: "User 10",
                },
                {
                    src: "https://placehold.co/32x32/2ECC71/FFFFFF?text=K",
                    alt: "User 11",
                },
                {
                    src: "https://placehold.co/32x32/E67E22/FFFFFF?text=L",
                    alt: "User 12",
                },
            ],
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        >
                            AI-powered resume builder that gets you more
                            interviews. Stand out with professionally crafted
                            resumes.
                        </motion.p>
                        ...
                        >
                            <button className="bg-cyan-500 hover:bg-cyan-600 text-white px-8 py-3 rounded-lg font-semibold transition">
                                Build Your Resume
                            </button>
                        ...
                        <motion.div variants={itemVariants}>
                            {/* 2. Phần text */}
                            <div className="flex flex-wrap items-center gap-x-6 text-sm text-gray-600 mt-5">
                                ...
                                <span>
                                    ...
                                    users achieved their dream jobs
                                </span>
                            </div>{" "}
                        </motion.div>
                    </motion.div>
                    ...
                    >
                        ...
                        {floatingCards.map((card) => (
                            ...
                            >
                                {/* Tag */}
                                <div
                                    className={`inline-block ${card.tagColor} px-3 py-1 rounded-full text-xs font-semibold mb-3`}
                                >
                                    {card.tag}
                                </div>
