        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center text-xl font-bold">
              <img src="/typhoon.png" alt="HireWise Logo" className="h-7 w-auto mr-2" />
                ...
                <div>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span>{isLoggedIn ? 'My Account' : 'Sign In / Sign Up'}</span>
                    </div>
                    <ChevronDown className={`w-4 h-4 text-gray-500 transition-transform duration-200 ${isMobileUserSubmenuOpen ? "rotate-180" : ""}`} />
                  </button>
