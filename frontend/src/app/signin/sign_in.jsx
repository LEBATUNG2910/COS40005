    ...
    <div className="bg-white rounded-lg shadow-lg p-8 animate-slide-up">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-3">
          {/* Google */}
          <a href="/auth/google/callback" type="button" className="w-full flex items-center justify-center gap-3 border border-gray-300 hover:bg-gray-50 hover:border-cyan-300 text-gray-700 font-medium py-3 px-4 rounded-lg transition-all duration-300 animate-fade-in" style={{ animationDelay: "0.6s" }}>
